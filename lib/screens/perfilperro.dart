              ...
              children: [
                ...
                Container(
                  ...
                  child: Image.asset(
                    ...
                    fit: BoxFit.fitWidth,
                    width: double.infinity, // Asegura que tome todo el ancho
                  ),
                ),
                ...
                Padding(
                  ...
                  // Sin extend para que se adecue a la pantalla
                  child: Align(
  ...
  Widget build(BuildContext context){
    ...
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          // Primera fila / Nombre y botón seguir
          Padding(
            padding: EdgeInsets.only(left: 5, right: 5,),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                // 2. El texto no empuje al botón Seguir
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          // Expanded al texto largo para que baje a otra línea si no cae
                          Expanded(
                            child: Text(
          ...
          // Segunda fila / Cards con FittedBox
          Padding(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            Row(
                              children: [
                                Icon(Icons.flatware, size: 26),
                                Text('Última comida:', style: TextStyle(fontSize: 10))
                              ],
                            ),
                            Text(
